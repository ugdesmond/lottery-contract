...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          beforeEach(async () => {
              ...
              secondRaffle = raffleContract.connect(accounts[2])
          ...
          describe("enterRaffle", async function () {
              ...
              it("record player when they enter", async function () {
                  ...
                  assert.equal(playerFromContract, address)
              })
              ...
              it("doesnt allow entrance when raffle is calculating", async function () {
                  ...
                  //we pretend to be chainlink upkeep
          ...
          describe("checkUpKeep", async function () {
              ...
              it("returns false if raffle isn't open", async () => {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  await secondRaffle.enterRaffle({ value: raffleEntranceFee })
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
              ...
              it("returns false if not yet time interval", async () => {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
